      ...
      child: Center(
        child: Text(
          ...
          style: CustomWidget(context: context).CustomSizedTextStyle(16.0,
              Theme
                  .of(context)
                  .splashColor, FontWeight.w400, 'FontRegular'),
        ),
      ),
    );
  }
                                    ...
                                    Flexible(
                                      child: GestureDetector(
                                        onTap: () {
                                          setState(() {
                                            QuickindexVal = 0;
                                            QuickselectedmarketAseet =
                                                QuickmarketAseetList.first;
                                            ...
                                            // }
                                            QuickselectPair =
                                                QuicktradePair.first;

                                            QuickfirstCoin =
                                                QuickselectPair!.baseAsset
                                                    .toString();
                                            QuicksecondCoin =
                                                QuickselectPair!.marketAsset
                                                    .toString();
                                            buySell = true;
              ...
              children: [
                ...
                Text(
                  ...
                  style: CustomWidget(context: context).CustomSizedTextStyle(
                      ...
                      Theme
                          .of(context)
                          .splashColor, FontWeight.w500, 'FontRegular'),
                ),
                const SizedBox(
                  height: 10.0,
                ),
                              ...
                              Flexible(
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        QuicktradePair[index].tradePair
                                            .toString(),
                                        style: CustomWidget(context: context)
                                            .CustomSizedTextStyle(
                                            13.0,
                  ...
                  onTap: () {
                    Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) =>
                            TradeChartScreen(pair: marginOption ? QuickfirstCoin
                                .toLowerCase() + "_" +
                                QuicksecondCoin.toLowerCase() : firstCoin
                                .toLowerCase() + "_" +
                                secondCoin.toLowerCase())));
                  },
                  child: SvgPicture.asset(
                    'assets/images/chart.svg', height: 25.0,),
                )
              ]),
          const SizedBox(
            height: 10.0,
                    ...
                    children: [
                      quote
                        ...
                        children: [
                          Text(
                            "Total " +
                                (buySell ? QuickfirstCoin : QuicksecondCoin),
                            style: CustomWidget(context: context)
                                .CustomSizedTextStyle(
                                12.0,
                                Theme
                          ...
                          Text(
                            quickAmountController.text.isEmpty
                                ? "0.00"
                  ...
                  onTap: () {
                    setState(() {
                      ...
                      if (double.parse(QuicklivePrice) > 0) {
                        ...
                        if (double.parse(perce.toString()) > 0 || perce
                            .toString() != "Infinity") {
                          quickAmountController.text =
                          ...
                          totalAmount =
                              double.parse((a * b).toString()).toStringAsFixed(
                                  8);
                        } else {
                          quickAmountController.clear();
                        }
              ...
              child: Center(
                child: Text(
                  quote
                      ...
                      " " +
                      QuickfirstCoin
                      : buySell ? "Buy Preview".toUpperCase() : "Sell Preview"
                      .toUpperCase(),
                  style: CustomWidget(context: context).CustomSizedTextStyle(
                      14.0,
                      Theme
      ...
      setState(() {
        if (loginData.success!) {
          ...
          _colorTween = ColorTween(
              begin: Colors.grey.withOpacity(0.5), end: Colors.transparent)
              .animate(_animationController!);
          changeColors();
          loading = false;
        } else {
