                      ...
                      setState(() {
                        ...
                        if (selectedtrasnType.toLowerCase() == "all") {
                          ...
                          for (int m = 0; m < AllHistory.length; m++) {
                            if (AllHistory[m].action.toString().toLowerCase() ==
                                selectedtrasnType.toLowerCase()) {
             ...
             child:   transHistory.length > 0
                 ...
                 itemBuilder: (BuildContext context, int index) {
                   var date = DateTime.fromMicrosecondsSinceEpoch(
                       int.parse(transHistory[index].timestamp.toString()) *
                           1000);
                                 ...
                                 children: [
                                   ...
                                   Column(
                                     ...
                                     children: [
                                       ...
                                       Text(
                                         transHistory[index].action.toString(),
                                         style: CustomWidget(context: context)
                                             .CustomTextStyle(
