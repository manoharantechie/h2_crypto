...
//
//     final getPostAdData = getPostAdDataFromJson(jsonString);

import 'dart:convert';

import 'package:h2_crypto/data/model/my_ad_details_model.dart';

GetPostAdData getPostAdDataFromJson(String str) => GetPostAdData.fromJson(json.decode(str));

String getPostAdDataToJson(GetPostAdData data) => json.encode(data.toJson());
...
class GetPostAdData {
  ...
  factory GetPostAdData.fromJson(Map<String, dynamic> json) => GetPostAdData(
